...
<div class="grid grid-cols-1 lg:grid-cols-3  gap-6">
  ...
  <aside>
      ...
      <ul>
          ...
          <li class="mb-4">
              <a class="flex" href="{{route('post.show',$similar->id)}}">
                @if ($similar->image)
                <img class="w-36 h-30 object-cover object-center" src="{{Storage::url($similar->image->url)}}" alt="">
                @else
                <img class="w-36 h-20 object-cover object-center" src="https://cdn.pixabay.com/photo/2015/12/04/14/05/code-1076536_960_720.jpg" alt="">
                @endif
